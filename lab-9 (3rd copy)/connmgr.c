...
//added part to observe the timeout 
...
void connmgr_listen(int port_number,dplist_t ** buffer,pthread_rwlock_t *lock)
{


int SERVER_PORT = port_number; // atoi = ASCII TO Int
       ...
       // do
        //{
         ...
         /*   fwrite(&id, sizeof(sensor_id_t), 1, fptr); 
          ...
          dpl_insert_at_index(*buffer,dataToBuffer,dpl_size(*buffer)+1,false);
        ...
        //  printf("new time stamp for %i is %lu\n",id,((sensor* )(dpl_get_element_at_index(list,dpl_get_index_of_element(list,sensor1))))->last_update);
